	...
	) : wxFrame(parent, id, title, pos, size, style)
{
	...
	wxMenuItem* newProjectItem;
	newProjectItem = new wxMenuItem(fileMenu, wxID_ANY, wxString(_("New Project")) , wxEmptyString, wxITEM_NORMAL);
	...
	gSizer2->Add(m_genericDirCtrl1, 1, wxEXPAND|wxALL, 5);
	...
	gSizer2->Add(textEditor, 1, wxALIGN_CENTER_HORIZONTAL|wxALL|wxEXPAND, 5);
